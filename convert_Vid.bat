...
ptime ffmpeg  -i "%%~A" -s hd720 -c:v libx265 -pix_fmt yuv420p -crf 23 -c:a aac "C:\Photos\tmp_videos\%%~nxB_%%~nA.mkv"
REM ffmpeg -i "%%~A" -s hd720 -c:v hevc_nvenc -pix_fmt yuv420p -preset slow -c:a aac "C:\Photos\tmp_videos\%%~nxB-%%~nA.mkv"
