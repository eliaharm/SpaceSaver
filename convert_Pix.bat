...
REM ptime C:\PortableApps\ImageMagick-7.0.8-10-portable-Q16-x64\convert.exe "%%~A" -normalize -sigmoidal-contrast 1.5 -colorspace HCL -channel g -sigmoidal-contrast 1.0,0%% +channel -colorspace sRGB +repage  -colorspace RGB -filter Lanczos -define filter:lobes=2 -define filter:blur=0.88451002338585141 -resize "2200x2200>" -colorspace sRGB -quality 92 "D:\Photos\tmp_photos\%%~nxB\%%~nA.jpg"
 ptime magick convert "%%~A"  -colorspace RGB -filter Lanczos  -define filter:blur=0.88451002338585141  -define filter:lobes=2 -resize "2200x2200>" -colorspace sRGB -normalize -sigmoidal-contrast 1.5 -colorspace HCL -channel g -sigmoidal-contrast 1.0,0%% +channel -colorspace sRGB +repage  -quality 92 "C:\Photos\tmp_photos\%%~nxB\%%~nA.jpg"
